const Footer = ()=>{
  ...
  <div className="mx-auto max-w-5xl pt-8 pb-16">
          ...
          <a className="pr-4 pt-0.5"  target="_blank" href="https://instagram.com/sahilwise">
          ...
          <a className="pr-5" target="_blank" href="https://www.producthunt.com/@sahilwise">
          ...
          <a className="pr-5 pt-0.5" target="_blank" href="https://x.com/sahilwise">
